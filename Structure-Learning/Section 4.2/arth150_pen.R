...
#### Load data (arth150 - https://www.degruyter.com/document/doi/10.2202/1544-6115.1175/html)
arth150 = readRDS(paste0(dirname(getwd()), '/Data/arth150.rds'))
arth150_W = bnlearn::as.igraph(arth150)

W = as.matrix(as_adjacency_matrix(arth150_W))
num_edges = sum(W)
...
for (b in 1:B) {
  ...
  X = as.matrix( bnlearn::rbn(arth150, N) )
  X = scale(X)
...
write.csv(df_results,
          paste0("../Results/arth150_pen2logp_B", B,".csv"))
